...
export default function AddMember() {
    ...
    const handleAddMember = async () => {
        ...
        formData.append("monthlyContributionAmount", user.monthlyContributionAmount);
        formData.append("identification", user.identification);
        formData.append("gender", user.gender);
        if (files.length
            && files[0].file.size < 2 * 1024 * 1024
        ...
        formData.append("image_url", files[0].file);
            ...
            setErrors({ ...errors, image: "Image should be less than 2MB and in jpg, jpeg, or png format" });
            console.log("Image should be less than 2MB and in jpg, jpeg, or png format");
            return;
        }
        ...
        <div className="add-member-page">
            ...
            >
                <MemberEditPopup
                    ...
                    data="You have successfully added a new member"
                />
            </div>
                ...
                <div className="add-member-inputs">
                    ...
                    <fieldset className="parallel-fields">
                        ...
                        <FormField
                            ...
                            onChange={(e) => {
                                setUser({ ...user, monthlyContributionAmount: e.target.value});
                            }}
                        />
                    </fieldset>
