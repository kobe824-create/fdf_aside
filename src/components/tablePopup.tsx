...
export default function TablePopup(props: TableProps) {
    const { data } = props;
    return (
            ...
            <div className="table">
                ...
                <div className="table-heading">
                    <div className="search-input">
                        ...
                        <input type="text" placeholder="Search by Enter name, ID…" />
                    </div>
                                    ...
                                    <tr key={index}>
                                        {
                                            row.map((cell, idex) => {
                                                return cell === "paid" ? 
                                                (<td key={idex}>
                                                    <p className="cont-paid">
                                                        Paid
                                                    </p>
                                                </td>) : 
                                                cell === "unpaid" ? 
                                                (<td key={idex}>
                                                    <p  className="cont-unpaid">Unpaid</p>
                                                </td>) :
                                                (<td key={idex}>{cell}</td>)      
                                            })
                                        }
                    ...
                    <div className="pagination">
                        <div className="page">
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                                <path d="M4.86015 9.3934L1.14015 5.66673C1.01598 5.54183 0.946289 5.37286 0.946289 5.19673C0.946289 5.02061 1.01598 4.85164 1.14015 4.72673L4.86015 1.00007C4.9534 0.906047 5.07253 0.841927 5.20236 0.815881C5.3322 0.789834 5.46684 0.803042 5.58914 0.85382C5.71143 0.904598 5.81584 0.990645 5.88904 1.10099C5.96224 1.21134 6.00092 1.34098 6.00015 1.4734V8.92007C6.00092 9.05248 5.96224 9.18213 5.88904 9.29248C5.81584 9.40282 5.71143 9.48887 5.58914 9.53965C5.46684 9.59042 5.3322 9.60363 5.20236 9.57759C5.07253 9.55154 4.9534 9.48742 4.86015 9.3934Z" fill="#686F83" />
                            </svg>
                        </div>
                        <div className="page">
                            <p>1</p>
                        ...
                        <div className="page">
                            <svg xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 6 10" fill="none">
                                <path d="M1.12779e-05 8.92007V1.4734C-0.000758787 1.34098 0.0379226 1.21134 0.111123 1.10099C0.184324 0.990645 0.288728 0.904598 0.411024 0.85382C0.53332 0.803042 0.667968 0.789834 0.7978 0.815881C0.927632 0.841927 1.04677 0.906047 1.14001 1.00007L4.86002 4.72673C4.98419 4.85164 5.05388 5.02061 5.05388 5.19673C5.05388 5.37286 4.98419 5.54183 4.86002 5.66673L1.14001 9.3934C1.04677 9.48742 0.927632 9.55154 0.7978 9.57759C0.667968 9.60363 0.53332 9.59042 0.411024 9.53965C0.288728 9.48887 0.184324 9.40282 0.111123 9.29248C0.0379226 9.18213 -0.000758787 9.05248 1.12779e-05 8.92007Z" fill="#686F83" />
                            </svg>
                        </div>
                    </div>
                </div>
